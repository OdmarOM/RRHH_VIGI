...
def test_get_departamentos(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Departamentos obtenidos: {len(response.json())}")
    else:
        print("❌ Error al obtener departamentos")
...
def test_get_empleados(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Empleados obtenidos: {len(response.json())}")
    else:
...
def test_get_turnos(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Turnos obtenidos: {len(response.json())}")
    else:
        print("❌ Error al obtener turnos")
...
def test_get_plantillas(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Plantillas obtenidas: {len(response.json())}")
    else:
...
def test_get_usuarios_sistema(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Usuarios del sistema obtenidos: {len(response.json())}")
    else:
        print("❌ Error al obtener usuarios del sistema")
...
def test_get_roles(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Roles obtenidos: {len(response.json())}")
...
def test_get_supervisores_departamentos(token):
    ...
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        print(f"✅ Relaciones obtenidas: {len(response.json())}")
    else:
        print("❌ Error al obtener relaciones")
...
def test_activar_desactivar_empleado(token, empleado_id):
    ...
    if response.status_code == 200:
        ...
        print("❌ Error al desactivar empleado")
